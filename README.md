...
Проект развивается благодаря помощи:
- [@suspect2xx](https://github.com/suspect2xx) – за тестирование и ценные советы


## 🛡️ Антивирусные ложные срабатывания

Некоторые антивирусы могут ложно определять Xfreme Toolbox как вредоносное ПО из-за способа упаковки (PyInstaller) и поведения (запрос прав администратора, редактирование реестра). Это **ложные срабатывания**.

Подробное объяснение и список вендоров, которые детектируют файл, смотрите в [VIRUSTOTAL.md](VIRUSTOTAL.md).

**Все 64 ведущих антивируса** (включая Kaspersky, BitDefender, ESET) считают файл чистым. Исходный код полностью открыт – вы можете проверить его самостоятельно.
